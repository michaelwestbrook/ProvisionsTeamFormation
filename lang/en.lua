...
ZO_CreateStringId("SI_TF_SETTING_REFRESHRATE_TOOLTIP", "Change the time in milliseconds between refresh of TeamFormation.  |cFFFFFF     20 fps = 50 ms        60 fps = 16 ms      30 fps = 33 ms      100 fps = 10 ms      40 fps = 25 ms|r")
...
ZO_CreateStringId("SI_TF_SETTING_LOGDIST_TOOLTIP", "0 = Linear Adjusts the maximum pin distance.")
...
ZO_CreateStringId("SI_TF_SETTING_YOURALPHA_TOOLTIP", "0 = Hidden Changes the transparency of the player arrow (blue arrow).")
...
ZO_CreateStringId("SI_TF_SETTING_JRULES_COLORCHOICE_TOOLTIP", "0 = Disabled Choose the color for the player icon.")
