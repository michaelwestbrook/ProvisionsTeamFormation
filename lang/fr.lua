...
ZO_CreateStringId("SI_TF_SETTING_REFRESHRATE_TOOLTIP", "Nombre de millisecondes entre chaque actualisation de l'interface.  |cFFFFFF     20 fps = 50 ms        60 fps = 16 ms      30 fps = 33 ms      100 fps = 10 ms      40 fps = 25 ms|r")
...
ZO_CreateStringId("SI_TF_SETTING_LOGDIST_TOOLTIP", "0 = Linéaire Permet de faire apparaître les répéres lointain plus proche (réduction de la distance).")
ZO_CreateStringId("SI_TF_SETTING_CARDINAL", "Transparence des points cardinaux")
ZO_CreateStringId("SI_TF_SETTING_CARDINAL_TOOLTIP", "0 = Masqué Modifie la transparence des points cardinaux.")
...
ZO_CreateStringId("SI_TF_SETTING_YOURALPHA_TOOLTIP", "0 = Masqué Modifie la transparence de votre point (flèche bleue).")
...
ZO_CreateStringId("SI_TF_SETTING_JRULES_COLORCHOICE_TOOLTIP", "0 = Désactivé Choisissez la couleur de l'icône.")
